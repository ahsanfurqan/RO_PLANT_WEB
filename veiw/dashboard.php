...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title> RO PLANT Dashboard</title>
        ...
        <div class="lime-sidebar">
            <div class="lime-sidebar-inner slimscroll">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="Company-Registration.php"><i class="material-icons">person_outline</i>Company Registration</a>
                    </li>
                    <li>
                        <a href="Employee-Registration.php"><i class="material-icons">person_outline</i>Employee Registration</a>
                    </li>
                    <li>
                        <a href="Customer-Registration.php"><i class="material-icons">person_outline</i>Customer Registration</a>
                    </li>
                    <li class="sidebar-title">
                        UI Elements
                    </li>
                    ...
                    <li>
                        <a href="forms.html" class="active"><i class="material-icons">input</i>Forms</a>
                    </li>
                    <li class="sidebar-title">
                        Other
                    </li>
